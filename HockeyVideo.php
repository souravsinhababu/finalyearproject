...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">Upload Football Video  !</h2>
        
		
		<center>
		<form id="form1" name="form1" method="post" action="HockeyVideodata.php">
	...
	<?php
					include("config.php");
					$result =mysql_query("Select MAX(ID) as id from HockeyVideo");
