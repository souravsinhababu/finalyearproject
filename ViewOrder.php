...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">FootBall KIT Order Details !</h2>
		...
		<form id="form1" name="form1" method="post" action="">
		  <table style="width:50%;color:#660099; font-family:'Times New Roman', Times, serif; font-size:16px; font-weight:bold;" >
            ...
            <tr>
	          ...
	          <tr>
                <td colspan="2" align="center"><input type="submit" name="Submit" value="Submit" style="width:120px; height:30px; background-color:#003399; color:#FFFFFF"/>
                  &nbsp;&nbsp;</td>
	            </tr>
	          <tr>
	            <td>&nbsp;</td>
	...
	<table width="680" cellpadding="4" border="1" align="center" style="background-color:#99FFFF;">
    <tr>
		<td style="background-color:#00FFFF;color:#000033">OrderID</td>
		<td style="background-color:#00FFFF;color:#000033">Date</td>
		<td style="background-color:#00FFFF;color:#000033">UserName</td>
		<td style="background-color:#00FFFF;color:#000033">KitID</td>
		<td style="background-color:#00FFFF;color:#000033">Category</td>
		<td style="background-color:#00FFFF;color:#000033">Name</td>
		<td style="background-color:#00FFFF;color:#000033">Price</td>
		<td style="background-color:#00FFFF;color:#000033">Quantity</td>
		<td style="background-color:#00FFFF;color:#000033">TotalPrice</td>
