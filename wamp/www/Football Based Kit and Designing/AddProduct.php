...
<div class="wrapper col1">
  <div id="header">
    <div id="logo">
      <h1><a href="index.html">Atheltics KIT  </a></h1>
    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="AddTrainer.php">Trainer</a></li>
        <li><a href="ViewCustomer.php">Customer</a></li>
        <li><a href="ViewOrder.php">Order</a></li>
        <li><a href="Delivery.php">Delivery</a></li>
		<li><a href="HockeyVideo.php">Video</a></li>
		<li class="last"><a href="Tournament.php">Tournament</a></li>
      </ul>
    </div>
    <br class="clear" />
  </div>
  ...
  <div id="featured_slide">
    <div class="featured_box"><a href="#"><img src="images/1.jpg" alt="" /></a>
      <div class="floater">
        ...
        <p class="readmore"><a href="https://en.wikipedia.org/wiki/Atheltics" target="_blank">Continue Reading &raquo;</a></p>
      </div>
    </div>
...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">Add New FootBall KIT Details !</h2>
        
		
		<center>
		<form id="form1" name="form1" method="post" action="AddProductdata.php" enctype="multipart/form-data">
		  <table cellpadding="4" style="width:50%; color:#003300; font-family:'Times New Roman', Times, serif; font-size:16px; font-weight:bold;" >
            <tr>
            <td>KIT ID</td>
					<?php
					include("config.php");
					$result =mysql_query("Select MAX(KitID) as id from Product");
				  ...
				  <tr>
					...
					<select name="cat" id="cat">
					  ...
					  <option value=" Atheltics Kit"> Atheltics Kit </option>
					  <option value="Common KIT"> Common KIT </option>
					</select>					</td>
				    </tr>
				  ...
				  <tr>
					<td colspan="2" align="center">
					  <input type="submit" name="Submit" value="Submit" style="width:120px;height:30px; background-color:#0066FF; color:#FFFFFF"/> 
