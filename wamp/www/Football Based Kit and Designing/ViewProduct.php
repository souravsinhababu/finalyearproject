...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">View Product Details !</h2>
      ...
      <td>&nbsp;</td>
	          ...
	          <tr>
				...
				<table width="880" border="1" align="center" style="background-color:#99FFFF;">
    <tr>
		<td style="background-color:#00FFFF;color:#000033">KitID</td>
		<td style="background-color:#00FFFF;color:#000033">Category</td>
		<td style="background-color:#00FFFF;color:#000033">KitName</td>
		<td style="background-color:#00FFFF;color:#000033">BrandName</td>
		<td style="background-color:#00FFFF;color:#000033">Price</td>
		<td style="background-color:#00FFFF;color:#000033">Description</td>
		<td style="background-color:#00FFFF;color:#000033">Photo</td>
    </tr>
	<?php 
include("config.php");
