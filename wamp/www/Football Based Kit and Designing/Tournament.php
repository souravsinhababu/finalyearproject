...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">Add Football Tournament Details !</h2>
        
		
		<center>
		<form id="form1" name="form1" method="post" action="Tournamentdata.php">
	...
	<?php
					include("config.php");
					$result =mysql_query("Select MAX(ID) as id from Tournament");
  ...
  <tr>
    <td>Address  </td>
    <td><textarea rows="5" cols="30" name="addr" ></textarea></td>
  </tr>
  <tr>
    <td>Date</td>
