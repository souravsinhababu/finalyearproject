...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">Add New Trainer's !</h2>
        
		
		<center>
		<form id="form1" name="form1" method="post" action="Addtrainerdata.php" enctype="multipart/form-data">
		  <table cellpadding="4" style="width:50%; color:#003300; font-family:'Times New Roman', Times, serif; font-size:16px; font-weight:bold;" >
            <tr>
            <td>Trainer ID</td>
					<?php
					include("config.php");
					$result =mysql_query("Select MAX(id) as id from trainer");
