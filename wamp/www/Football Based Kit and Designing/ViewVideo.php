...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">View Video Details !</h2>
		...
		<form id="form1" name="form1" method="post" action="">
		  <table style="width:50%; color:#660099; font-family:'Times New Roman', Times, serif; font-size:16px; font-weight:bold;" >
            ...
            <tr>
                <td style="font-size:18px; font-weight:bold" align="center">Select  Type 
	          ...
	          <tr>
                <td colspan="2" align="center"><input type="submit" name="Submit" value="Submit" style="width:120px;height:30px; background-color:#0066FF; color:#FFFFFF"/></td>
	          </tr>
	          <tr>
	            <td>&nbsp;</td>
      <td>&nbsp;</td>
	          ...
	          <tr>
				...
				<table width="680" border="1" align="center" style="background-color:#99FFFF;">
    <tr>
		<td style="background-color:#00FFFF;color:#000033">ID</td>
		<td style="background-color:#00FFFF;color:#000033">Category</td>
		<td style="background-color:#00FFFF;color:#000033">Name</td>
		<td style="background-color:#00FFFF;color:#000033">VideoLink</td>
...
if(isset($_POST['Submit']))
{
	...
	$result =mysql_query("Select * from HockeyVideo where Category = '$Category'");
	$id = $_POST['menu1'];
    ...
    <tr>
	  ...
	  <td> <a target="_blank" href="<?php echo $row['VideoLink']; ?>" rel="prettyPhoto[gallery1]" title="Video 1"><img src="images/video.gif" alt="" /></a> </td>
