...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">View Customer Details !</h2>
        
		
		<center>
		  <table width="300px" style=" color:#660099; font-family:'Times New Roman', Times, serif; font-size:16px; font-weight:bold;" >
  <tr>
    <td style="font-size:18px; font-weight:bold" align="center">&nbsp;</td>
  </tr>
 <tr>
	            <td>
				
				
				<table width="480" border="1" align="center" style="background-color:#99FFFF;">
    <tr>
