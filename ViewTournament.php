...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">View Tournament Details !</h2>
      ...
      <td>&nbsp;</td>
	          ...
	          <tr>
				...
				<table width="880" cellpadding="4" border="1" align="center" style="background-color:#99FFFF;">
    <tr>
...
if(isset($_POST['Submit']))
{
	...
	$result =mysql_query("Select * from Tournament where Category = '$Category'");
	$id = $_POST['menu1'];
