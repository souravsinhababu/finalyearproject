...
<div class="wrapper col0">
  <div id="topbar">
    <div id="slidepanel" style="background-color:#FF8000;color:#000066;">
      <div class="topbox" >
        <h2>FootBall KIT and Designing</h2>
        <p>Hockey is a type of sport in which players try to get points by hitting an object into the other team's goal with a stick. Others believe hockey came from the French word "hoquet" which means shepherd's stick. James Creighton, an engineer who learned how to play the game of hockey while living in Nova Scotia, is credited for bringing the game to a new level....</p>
        <p class="readmore"><a style="background-color:#FF8000;color:#000066;" target="_blank" href="https://simple.wikipedia.org/wiki/Hockey">Continue Reading &raquo;</a></p>
      </div>
      <div class="topbox">
        ...
        <form action="UserLogin.php" method="post">
          <fieldset>
			...
			<br />
			<p class="readmore"><a style="background-color:#FF8000;color:#000066;" href="Register.php">New User Register Here &raquo;</a></p>
          </fieldset>
        </form>
      </div>
    ...
    <div id="loginpanel">
      <ul>
        ...
        <li class="right" id="toggle"><a id="slideit" href="#slidepanel">Admin & User</a><a id="closeit" style="display: none;" href="#slidepanel">Close Panel</a></li>
      </ul>
    </div>
    <br class="clear" />
  </div>
  ...
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="pages/style-demo.html"></a></li>
...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">New User Registration !</h2>
        
		
		<center>
		<form id="form1" name="form1" method="post" action="Registerdata.php" >
		  <table cellpadding="4" style="width:50%; color:#003300; font-family:'Times New Roman', Times, serif; font-size:16px; font-weight:bold;" >
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
  ...
  <tr>
    ...
    <td><textarea rows="4" cols="30" name="address" ></textarea></td>
              ...
              <tr>
                <td colspan="2" align="center"><input type="submit" name="Submit" value="Submit" style="width:120px;height:30px; background-color:#0066FF; color:#FFFFFF"/>
                  &nbsp;&nbsp;
                  <input type="reset" name="Submit2" value="Reset" style="width:120px;height:30px; background-color:#0066FF; color:#FFFFFF"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td></td>
